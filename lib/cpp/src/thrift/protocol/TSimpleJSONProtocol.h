...
class TSimpleJSONProtocol : public TVirtualProtocol<TSimpleJSONProtocol> {
 ...
 private:
  ...
  void pushContext(boost::shared_ptr<TSimpleJSONContext> c);
 ...
 private:
  ...
  std::stack<boost::shared_ptr<TSimpleJSONContext> > contexts_;
  boost::shared_ptr<TSimpleJSONContext> context_;
